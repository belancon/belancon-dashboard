        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('social_media/update/'.$socmed->id, array('class'=>'form-horizontal')); ?>
                    <div class="content">
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Nama <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo $socmed->name;?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="icon" placeholder="Icon" value="<?php echo $socmed->icon;?>" />
