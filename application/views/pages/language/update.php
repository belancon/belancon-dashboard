        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- Form -->
                    <?php echo form_open('language/do_update', array('class'=>'form-horizontal', 'id'=> 'form')); ?>
                    <input type="hidden" name="id" value="<?php echo $model->id;?>">
                    <div class="content">
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Name <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo $model->name;?>"/>
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="value" class="col-sm-2 control-label">Value <span class="text-danger">*</span></label>
                            <div class="col-sm-10">                                
                                <textarea class="form-control" name="value" rows="4"><?php echo $model->value;?></textarea>
                            </div>
                        </div>   
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                if($model->lang == $language['value']):
                                ?>                                
                                <option value="<?php echo $language['value'];?>" selected><?php echo $language['text'];?></option>
                                <?php else: ?>
